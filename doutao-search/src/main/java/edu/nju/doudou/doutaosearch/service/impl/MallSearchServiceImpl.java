package edu.nju.doudou.doutaosearch.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import edu.nju.doudou.common.to.es.SkuEsModel;
import edu.nju.doudou.common.utils.R;
import edu.nju.doudou.doutaosearch.config.ElasticSearchConfig;
import edu.nju.doudou.doutaosearch.constant.EsConstant;
import edu.nju.doudou.doutaosearch.feign.ProductFeignService;
import edu.nju.doudou.doutaosearch.service.MallSearchService;
import edu.nju.doudou.doutaosearch.vo.AttrResponseVo;
import edu.nju.doudou.doutaosearch.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse response = esRestClient.search(searchRequest, ElasticSearchConfig.getCommonOptions());
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("http://search.doutao.com/list.html?" + replace);
...
// 品牌的面包屑导航
        if (param.getBrandId() != null && param.getBrandId().size() > 0) {
            ...
            // 根据 brandId 获取 品牌信息
            R brandInfoR = productFeignService.brandsInfo(param.getBrandId());
    ...
    private String replaceQueryString(SearchParam param, String value, String brandId) {
        String encode = null;
        try {
        ...
        return param.get_queryString().replace("&" + brandId + "=" + encode, "");
    }
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        LOGGER.debug("构建的DSL语句 {}",searchSourceBuilder.toString());
